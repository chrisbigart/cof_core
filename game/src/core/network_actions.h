...
constexpr quint32 MAX_NETWORK_MESSAGE_SIZE = 10 * 1024 * 1024; // 10 MB
...
enum client_action_e : quint8 {
	...
	ACTION_ADVENTURE_MAP_ATTACK_HERO,
	ACTION_ADVENTURE_MAP_ATTACK_TOWN,
	...
	ACTION_ADVENTURE_MAP_CAST_SPELL,
...
enum server_response_e : quint8 {
	...
	RESPONSE_MULTIPLAYER_SCENARIO_INFO,
	RESPONSE_MULTIPLAYER_SCENARIO_SETUP_START,
	RESPONSE_MULTIPLAYER_SCENARIO_START,
	RESPONSE_MULTIPLAYER_SCENARIO_END,
	RESPONSE_GAME_INFO,
